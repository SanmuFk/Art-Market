  ...
  <div class="shopping">
    ...
    <div class="shopping-main">
      ...
      <div class="shopping-main-content" v-if="choose ===0">
        ...
        <div class="container">
          <article class="container-item" v-for="(item,index) in loveProduct" @click="goToWork(item.work_id)">
      ...
      <div class="shopping-main-content" v-if="choose ===1">
        ...
        <div class="container" v-if="isClick===0">
          <article class="container-item" v-for="(item,index) in product" @click="goToWork(item.work_id)">
            <div class="cursor-pointer">
              <div class="item-show" :style="{'backgroundImage':'url('+ item.exhibition+')'}"></div>
              <div class="item-center">
                <article style="width: 60%;">
        ...
        <div class="container" v-if="isClick===1">
          <article class="container-item" v-for="(item,index) in saleProduct" @click="goToWork(item.work_id)">
            <div class="cursor-pointer">
              <div class="item-show" :style="{'backgroundImage':'url('+ item.exhibition+')'}"></div>
              <div class="item-center">
                <article style="width: 60%;">
        ...
        <div class="container" v-if="isClick===2">
          <article class="container-item" v-for="(item,index) in unsaleProduct" @click="goToWork(item.work_id)">
            <div class="cursor-pointer">
              <div class="item-show" :style="{'backgroundImage':'url('+ item.exhibition+')'}"></div>
              <div class="item-center">
                <article style="width: 60%;">
...
<style scoped>
.header >>> .headerRight .right #museum{
  color:deepskyblue;
}
